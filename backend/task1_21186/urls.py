...
admin.site.site_header = "Task1"
admin.site.site_title = "Task1 Admin Portal"
admin.site.index_title = "Task1 Admin"

# swagger
api_info = openapi.Info(
    title="Task1 API",
    default_version="v1",
    description="API documentation for Task1 App",
)
